...
export default function POS({
    ...
    // Auto-fill paid amount saat total berubah
    useEffect(() => {
    ...
    return (
        <AppLayout>
            ...
            <div className="h-[calc(100vh-72px)] bg-gradient-to-br from-[#fbfbfe] via-white to-[#dddbff]/30 flex overflow-hidden">
                        ...
                        <div className="flex flex-row gap-6 flex-1 overflow-hidden min-h-0">
                            ...
                            <div className="w-[92px] overflow-y-auto flex flex-col gap-4 flex-shrink-0 pb-4">
                                ...
                                <button
                                    ...
                                    className={`rounded-2xl h-[82px] flex-shrink-0 flex flex-col items-center justify-center gap-2 transition-all duration-300 ${
                                        selectedCategory === null
                                            ...
                                            : 'bg-white text-[#2f27ce] border border-[#dddbff] hover:border-[#443dff]'
                                    }`}
                                >
                                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${selectedCategory === null ? 'bg-white/20' : 'bg-[#dddbff]/50'}`}>
                                ...
                                {categories.map(cat => (
                                    ...
                                    >
                                        <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${selectedCategory === cat.id ? 'bg-white/20' : 'bg-[#dddbff]/50'}`}>
                ...
                {/* ── CART ── */}
                <div className="w-[380px] bg-white border-l border-[#dddbff] shadow-[-10px_0_30px_rgba(47,39,206,0.08)] flex flex-col h-[calc(100vh-72px)] relative z-10">
                                    ...
                                    <div key={`${item.menu_id}-${index}`} className="flex gap-3 items-start pb-4 border-b border-[#dddbff]/50 last:border-0 last:pb-0">
                                        ...
                                        <div className="flex items-center gap-1 flex-shrink-0 bg-gradient-to-br from-[#dddbff]/40 to-[#dddbff]/10 rounded-lg p-1 border border-[#dddbff]">
                                            <button onClick={() => decreaseQty(index)}
                                                className="w-6 h-6 rounded-md bg-white border border-[#dddbff] text-[#2f27ce] text-sm font-bold hover:bg-[#dddbff] transition-colors shadow-sm">
                                                &minus;
                                            </button>
                                            <span className="text-[12px] font-extrabold w-6 text-center text-[#050316]">{item.qty}</span>
                                            <button onClick={() => increaseQty(index)}
                                                className="w-6 h-6 rounded-md bg-gradient-to-br from-[#443dff] to-[#2f27ce] text-white text-sm font-bold hover:from-[#2f27ce] hover:to-[#050316] transition-colors shadow-sm">
                                                +
                                            </button>
                                        </div>
                    ...
                    <div className="border-t border-[#dddbff] p-5 flex-shrink-0 bg-gradient-to-t from-[#dddbff]/30 to-transparent">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 h-[52px] rounded-xl border border-[#2f27ce] text-[#2f27ce] font-bold text-[13px] hover:bg-[#dddbff]/30 disabled:opacity-40 transition-all shadow-sm flex items-center justify-center gap-1.5 bg-white"
                            >
                    ...
                    >
                        <div className="bg-white rounded-2xl w-full max-w-md p-7 shadow-2xl border border-[#dddbff]"
                            ...
                            <select
                                ...
                                className="w-full mb-5 h-12 rounded-xl border border-[#dddbff] bg-gradient-to-r from-[#dddbff]/30 to-[#fbfbfe] text-sm font-bold text-[#050316] px-4 focus:outline-none focus:ring-2 focus:ring-[#443dff] transition-all cursor-pointer"
                            >
                            ...
                            <div className="relative mb-5">
                                ...
                                <input
                                    ...
                                    min={0}
                                    step={1000}
                                    className="w-full h-12 rounded-xl border border-[#dddbff] bg-[#dddbff]/10 text-lg font-black text-[#050316] pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-[#443dff] focus:bg-white transition-all"
                                />
                            </div>
