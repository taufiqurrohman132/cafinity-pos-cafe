            ...
            <div className="relative bg-white rounded-2xl shadow-2xl border border-[#dddbff] w-full max-w-md mx-4 p-6 z-10">
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                        {[
                            { label: "Dari Tanggal", key: "start_date", type: "date" },
                            { label: "Sampai Tanggal", key: "end_date", type: "date" },
                        ].map(({ label, key, type }) => (
                            <div key={key}>
                                ...
                                <input
                                    ...
                                    className="w-full border border-[#dddbff] rounded-xl px-3 py-2 text-sm text-[#050316] focus:outline-none focus:border-[#443dff]"
                                />
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 bg-white border border-[#dddbff] rounded-xl px-3 py-2 shadow-sm">
                            ...
                            <select
                                ...
                                className="text-sm font-bold text-[#050316] bg-transparent focus:outline-none"
                            >
