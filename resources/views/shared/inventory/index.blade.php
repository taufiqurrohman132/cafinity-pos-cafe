...
@section('content')
    ...
    <div class="min-h-screen bg-[#fbfbfe]">
            ...
            <div class="xl:col-span-9 p-4 md:p-6 space-y-6">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-gray-500 mt-1">Lacak dan kelola stok bahan baku operasional kafe Anda secara
                            real-time.</p>
                    </div>
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <form method="GET" action="{{ route('inventories.index') }}" class="flex items-center gap-2">
                            ...
                            <select name="status" onchange="this.form.submit()"
                                ...
                                <option value="low" {{ request('status') == 'low' ? 'selected' : '' }}>Stok Rendah
                                </option>
                                <option value="empty" {{ request('status') == 'empty' ? 'selected' : '' }}>Habis
                                </option>
                            </select>
                        </form>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl border border-[#dddbff] shadow-sm p-6">
                        <div class="flex justify-between items-start">
                            ...
                            <div
                                class="w-11 h-11 rounded-xl bg-[#dddbff] flex items-center justify-center text-[#2f27ce] text-xl flex-shrink-0">
                ...
                <div class="bg-white rounded-2xl border border-[#dddbff] shadow-sm overflow-hidden">
                    ...
                    {{-- TABLE HEADER --}}
                    <div
                        class="px-6 py-5 border-b border-[#dddbff] flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                                    ...
                                    <tr class="hover:bg-[#fbfbfe] transition">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-9 h-9 rounded-xl bg-[#dddbff] text-[#2f27ce] font-bold text-sm flex items-center justify-center flex-shrink-0">
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="px-2.5 py-1 rounded-full bg-[#fbfbfe] border border-[#dddbff] text-gray-600 text-xs font-medium">
                                                {{ $item->category?->name ?? '-' }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="px-2.5 py-1 rounded-full text-xs font-semibold {{ $statusStyles[$color] }}">
                                                {{ $status }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td colspan="7" class="px-6 py-10 text-center text-gray-400 text-sm">
                                            <div class="flex flex-col items-center gap-2">
                                                <iconify-icon icon="solar:box-outline"
                                                    class="text-4xl text-[#dddbff]"></iconify-icon>
                                                <p>Belum ada data inventaris.</p>
                                                <a href="{{ route('inventories.create') }}"
                                                    class="text-[#2f27ce] font-semibold hover:underline text-xs">
                    ...
                    {{-- TABLE FOOTER --}}
                    <div
                        class="px-6 py-4 border-t border-[#dddbff] flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div class="xl:col-span-3 border-l border-[#dddbff] bg-white p-4 md:p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('inventories.create') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-xl bg-[#443dff] flex items-center justify-center text-lg flex-shrink-0">
                        ...
                        <a href="{{ route('inventories.low-stock') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-xl bg-[#dddbff] flex items-center justify-center text-[#2f27ce] text-lg flex-shrink-0">
                                <iconify-icon icon="mdi:alert-outline"></iconify-icon>
                            </div>
                            <div>
                ...
                <div>
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ route('inventories.index') }}"
                            class="text-xs font-semibold text-[#2f27ce] hover:text-[#443dff]">Semua</a>
                    </div>
                ...
                <div class="bg-[#dddbff] border border-[#dddbff] rounded-2xl p-5">
                    <div class="flex items-start gap-3">
                        <div
                            class="w-9 h-9 rounded-xl bg-[#fbfbfe] flex items-center justify-center text-[#2f27ce] text-lg flex-shrink-0">
        ...
        {{-- FOOTER --}}
        <div
            class="border-t border-[#dddbff] bg-white px-6 py-4 flex flex-col lg:flex-row lg:items-center justify-between gap-2">
