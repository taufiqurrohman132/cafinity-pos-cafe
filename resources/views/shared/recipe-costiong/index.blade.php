    ...
    <div class="flex h-screen bg-gray-50 overflow-hidden">
        ...
        <div class="w-80 min-w-[280px] bg-white border-r border-gray-100 flex flex-col">
            ...
            <div class="p-5 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="#" class="w-8 h-8 bg-green-600 hover:bg-green-700 text-white rounded-full flex items-center justify-center font-bold text-lg transition">+</a>
            </div>
            ...
            <div class="flex-1 overflow-y-auto px-4 py-4 space-y-1">
                ...
                @foreach ($recipes as $resep)
                    ...
                    @endphp
                    <a href="{{ route('recipe.show', $resep) }}">
                    <div @class([
                        ...
                        <p class="text-[10px] font-semibold text-gray-400 mb-2">{{ strtoupper($resep->menu->category->name ?? 'N/A') }}</p>
                        <div class="flex justify-between items-center">
                            <span class="text-[10px] text-gray-500">HPP: Rp {{ number_format($resep->total_hpp, 0, ',', '.') }}</span>
                            <span class="text-xs font-bold text-gray-700">Rp {{ number_format($resep->menu->price ?? 0, 0, ',', '.') }}</span>
                        </div>
                    </div>
                    </a>
                @endforeach
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="bg-green-50 border border-green-100 rounded-2xl p-5">
                            ...
                            <div class="flex items-center gap-3">
                                <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($selectedRecipe->total_hpp, 0, ',', '.') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                            ...
                            <div class="flex items-center gap-2">
                                <p class="text-2xl font-bold text-gray-900">{{ $selectedRecipe->margin }}%</p>
                        ...
                        <div class="col-span-8 space-y-6">
                            ...
                            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                                <div class="flex justify-between items-center mb-5">
                                    ...
                                    <a href="{{ route('recipe.index') }}" class="flex items-center gap-1 text-xs font-semibold text-green-600 hover:text-green-700 transition">
                                        + Tambah Bahan
                                    </a>
                                </div>
                                ...
                                <table class="w-full text-sm">
                                    ...
                                    <tfoot>
                                        <tr class="border-t-2 border-gray-200">
                                            ...
                                            <td class="pt-4 font-bold text-gray-900 text-base">Rp {{ number_format($selectedRecipe->total_hpp, 0, ',', '.') }}</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                                ...
                                <div class="space-y-2 border-t border-gray-100 pt-4">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-xs font-bold text-gray-900">Rp {{ number_format($selectedRecipe->total_hpp, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-xs text-gray-500">Proyeksi Margin</span>
                                        <span class="text-xs font-bold text-gray-900">{{ $selectedRecipe->margin }}%</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                ...
                <div class="flex-1 flex items-center justify-center">
                    <div class="text-center space-y-4">
                        <div class="w-20 h-20 bg-green-50 rounded-full flex items-center justify-center mx-auto">
                            <iconify-icon icon="solar:book-outline" class="text-4xl text-green-500"></iconify-icon>
                        </div>
                        <h2 class="text-xl font-bold text-gray-800">Belum ada resep</h2>
                        <p class="text-sm text-gray-500">Tambahkan resep menu pertama untuk mulai menganalisis margin dan HPP.</p>
